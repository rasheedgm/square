...
CURSOR_WAIT = get_qt_enum(QtCore.Qt, "CursorShape", "WaitCursor")
WINDOW_MODAL = get_qt_enum(QtCore.Qt, "WindowModality", "WindowModal")
...
ITEM_IS_USER_CHECKABLE = get_qt_enum(QtCore.Qt, "ItemFlag", "ItemIsUserCheckable")
